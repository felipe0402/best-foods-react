export const data = [
  {
    id: 1,
    name: "Hamburguer de queijo duplo",
    category: "burger",
    image:
...
export const categories = [
  ...
  {
    id: 6,
    name: "Recompensas no restaurante",
    image:
